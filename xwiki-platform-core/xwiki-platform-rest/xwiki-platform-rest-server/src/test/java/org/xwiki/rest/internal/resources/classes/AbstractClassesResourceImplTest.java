...
/**
 * Abstract base class for REST class resource tests, providing shared setup.
 *
 * @since 10.11.10
 */
abstract class AbstractClassesResourceImplTest
{
    ...
    protected List<String> availableClasses = Arrays.asList("Foo.Class1", "XWiki.User", "XWiki.Protected", "Bar.Other");
    protected List<DocumentReference> documentReferences = Arrays.asList(
    ...
    protected List<Class> restClasses;
    ...
    void configure() throws Exception
    {
        ...
        ReflectionUtils.setFieldValue(getResource(), "uriInfo", uriInfo);
